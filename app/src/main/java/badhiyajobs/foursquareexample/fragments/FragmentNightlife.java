...
public class FragmentNightlife extends Fragment {
    ...
    public static FragmentNightlife newInstance(String param1, String param2) {
        FragmentNightlife fragment = new FragmentNightlife();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_fragment_nightlife, container, false);

        Bundle extras= getActivity().getIntent().getExtras();
        location = extras.getString("location");
        Oauth= ExampleTokenStore.getToken();
        urlfood = "https://api.foursquare.com/v2/venues/explore?client_id=YCFCCQ4SOYVNEKBFKCFUYCYM0AY4FH2PSP2S1BAKGRKV3MAX&limit=10&client_secret=Q4AQS04T5GOFDOQ24GRKG52BM2132G3P1K4PFRJBX4QVZ53G&v=20130815%20&oauth_token="+Oauth+"&ll="+location+"&query=nightlife";


        recyclerView = (RecyclerView) view.findViewById(R.id.listviewnightlife);
